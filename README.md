...
Product section with 8 product images

Hover effects on navbar items and product cards

Invisible hover boxes for smooth UI interaction
...
Improve CSS skills (Flexbox, positioning, hover effects)

Build confidence by recreating a popular UI using only HTML and CSS
